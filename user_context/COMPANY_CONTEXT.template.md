...
> **💡 Instructions:** Fill this out once, and Claude will adapt all advice (OKRs, PRDs, User Stories) to YOUR specific context. Copy this template to `COMPANY_CONTEXT.md` and customize it.
...
*Product-Toolkit by [Hendrik Hemken](https://linkedin.com/in/hendrikhemken) & [Sören von Sebelin](https://linkedin.com/in/soeren-von-sebelin)*
